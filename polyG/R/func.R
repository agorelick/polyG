...
##'
##' @export
generate_angular_distance_trees <- function(angular_dist_w_root, sel_normal_sample, colorfile, sample_name_change, ad_tree_w_root_dir, markerset, usedsamps, ns, power, new_sample_names, meanlen_diff_normal, bootstrap, bscut, subject_name, markergroup, replicate, tree_type='NJ') { 
    ...
    if (bootstrap==FALSE) {
        ...
        bstrees_file <- file.path(ad_tree_w_root_dir,paste0(subject_name,"_Bootstrapped_unrooted_angular_distance_tree_newnames_",markergroup,"_",replicate,"_",tree_type,".rds"))
        saveRDS(bstrees_newnames,file=bstrees_file)
        bsmatrices_file <- file.path(ad_tree_w_root_dir,paste0(subject_name,"_Bootstrapped_unrooted_angular_distance_matrices_newnames_",markergroup,"_",replicate,"_",tree_type,".rds"))
